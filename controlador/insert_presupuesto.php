    ...
    if (isset($_POST['expediente']) && isset($_POST['operacion']) && isset($_POST['nivel']) && isset($_POST['concepto']) && isset($_POST['momh']) && isset($_POST['momp']) && isset($_POST['momm']) && isset($_POST['tot']) && isset($_POST['refacciones']) && isset($_POST['tmomh']) && isset($_POST['tmomp']) && isset($_POST['tmomm']) && isset($_POST['ttot']) && isset($_POST['trefacciones']) && isset($_POST['subtotal']) && isset($_POST['iva']) && isset($_POST['total']) && isset($_POST['fecha'])) {
        ...
        if ($resultado == 1) {
            ...
            if ($existepresupuesto == 1) {
                echo 'Este presupuesto ya esta creado';
            } else {
                $res = $objeto2->inserte_presupuesto($expediente, $operacion, $nivel, $concepto, $momh, $momp, $momm, $tot, $refacciones, $tmomh, $tmomp, $tmomm, $ttot, $trefacciones, $subtotal, $iva, $total, $fecha);
                if ($res == 1) {
                    echo 1;
                } else {
