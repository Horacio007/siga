<?php
    ...
    if(isset($_POST["select_tipo"])){
        ...
        if ($lista_estatus == NULL) {
            ...
            echo '<select name="tpagof" id="tpagof" class="form-control"><option value="0">No hay tipo de pago</option>';
        }
        else {

            $output = '<select name="tpagof" id="tpagof" class="form-control"><option value="0">Seleccione Tipo de Pago:</option>';
