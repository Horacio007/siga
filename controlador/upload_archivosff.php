<?php
    ...
    if (isset($_POST['iexpediente']) && !empty($_FILES['izip'])) {
        ...
        if ($resultado == 1) {
            //echo 'entro en la parte que si esta registrado';
            ...
            if (!file_exists($carpeta)) {
                    ...
                    if ($total_imagenes == $files_count && $r == 1) {
            ...
            echo 'Hubo un problema al cargar el archivo y/o Vehiculo no encontrado y/o registrado';
        }
    }
?>