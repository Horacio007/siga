$(document).ready(function(){
    ...
    // le agrego la info
    $.ajax({
        url: '/siga/controlador/t_refaccionesEntregadas.php',
        type: 'POST',
        data: {
        ...
        success: function(result){
            ...
            if($("#lista_refacciones").length){
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'No se entregaron refacciones ',
                })
    ...
    //saco la informacion y pongo todo para poder editar bueno no todo
    ...
    $("#btn_buscar").on('click', function(){
        ...
        $.ajax({
            url: '/siga/controlador/existe_vehiculoAlEn.php',
            type: 'POST',
            data: {
                id: $("#id_vehiculo").val()
            },
    ...
    //le agrego la cosa para cambiar lo entregao
