<?php 
  include_once '../incluciones/sesion.php';
    ...
    if ($_SESSION['user'] == 'Ernesto' || $_SESSION['user'] == 'Karen' || $_SESSION['user'] == 'Alfredo' || $_SESSION['user'] == 'Erika') {
        header("Refresh:");
...
<div class="container-fluid">
        <form action="" enctype="multipart/form-data" method="post" id="formdata">
            <div class="row">
                <div class="col text-center">
                    <h3>Subir Archivos del Vehiculo</h3>
                </div>
            </div>
            <div class="row">
    ...
    <script src="/siga/vista/js/altaarchivosrefacciones.js"></script>