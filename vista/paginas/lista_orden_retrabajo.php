...
?>
<link rel="stylesheet" href="/siga/vista/css/lista_orden_retrabajo.css">
        ...
        <form action="" class="formdata" id="formdata">
            <div class="row">
                <div class="col text-center">
                    <h3>Listado de Ordenes de Re-Trabajo</h3>
                </div>
            </div>
            <br>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body" id="panel">
                            <div class="table-responsive">
                                <table id="lista_ordenesret" class="table table-striped table-bordered" border="0">
    ...
    <script src="/siga/vista/js/lista_orden_retrabajo.js"></script>
