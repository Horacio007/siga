...
?>
    <link rel="stylesheet" href="/siga/vista/css/lista_refas_entregadas.css">
        ...
        <form action="" class="formdata" id="formdata">
            <div class="row">
                <div class="col text-center">
                    <h3>Listado de Refacciones Entragadas</h3>
                </div>
            </div>
            <br>
            <div class="row">
    ...
    <script src="/siga/vista/js/lista_refas_entregadas.js"></script>
