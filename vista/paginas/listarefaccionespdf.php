...
?>
<link rel="stylesheet" href="/siga/vista/css/listadorefaccionesjtpd.css">
<div class="container-fluid">
    <form action="" class="formdata" id="formdata">
        <div class="row">
            <div class="col text-center">
                <h3>Listado de Refacciones Jefe de Taller</h3>
            </div>
        </div>
        <div class="row">
    ...
    <script src="/siga/vista/js/listadorefaccionesjtpd.js"></script>