...
?>
<link rel="stylesheet" href="/siga/vista/css/orden_retrabajo.css">
...
<div class="container-fluid">
    <form action="" class="formdata" id="formdata">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <label for=""></label>
                <button type="button" class="btn btn-primary btn-lg btn-block" id="btn_Buscar">Buscar</button></div>
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <input type="text" id="iobservacion" class="form-control">
            </div>
            <div class="col-md-2">
                <label for=""></label>
    ...
    <script src="/siga/vista/js/orden_retrabajo.js"></script>
